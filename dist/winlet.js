  ...
  return (0, _createClass2["default"])(WinLetWindow, [{
    ...
    value: function makeResizable() {
      ...
      this.el.querySelectorAll(".".concat(_types.LIBRARY_NAME, "-resize-handle")).forEach(function (handle) {
        handle.addEventListener("pointerdown", function (e) {
          ...
          var direction = handle.classList;
          var startX = e.clientX,
            startY = e.clientY;
          ...
          var onPointerMove = function onPointerMove(moveE) {
            ...
            var nw = direction.contains("".concat(_types.LIBRARY_NAME, "-nw"));
            var ne = direction.contains("".concat(_types.LIBRARY_NAME, "-ne"));
            var sw = direction.contains("".concat(_types.LIBRARY_NAME, "-sw"));
            var se = direction.contains("".concat(_types.LIBRARY_NAME, "-se"));
            if (direction.contains("".concat(_types.LIBRARY_NAME, "-n")) || nw || ne) {
              newHeight = Math.max(minHeight, startHeight - deltaY);
              newTop = startTop + deltaY;
            }
            if (direction.contains("".concat(_types.LIBRARY_NAME, "-s")) || sw || se) newHeight = Math.max(minHeight, startHeight + deltaY);
            if (direction.contains("".concat(_types.LIBRARY_NAME, "-w")) || nw || sw) {
              newWidth = Math.max(minWidth, startWidth - deltaX);
              newLeft = startLeft + deltaX;
            }
            if (direction.contains("".concat(_types.LIBRARY_NAME, "-e")) || ne || se) newWidth = Math.max(minWidth, startWidth + deltaX);
            if (ghostEl) {
              ghostEl.style.left = "".concat(newLeft, "px");
              ghostEl.style.top = "".concat(newTop, "px");
    ...
    value: (function () {
      var _virtualize = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee3(level) {
        var currentIndex, targetIndex, restoreMode, _t;
        return _regenerator["default"].wrap(function (_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _t = level;
              _context3.next = _t === "frozen" ? 3 : _t === "suspended" ? 4 : _t === "unloaded" ? 5 : 6;
              break;
            case 3:
      ...
      var _capture = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee5() {
        ...
        return _regenerator["default"].wrap(function (_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              mode = _args5.length > 0 && _args5[0] !== undefined ? _args5[0] : "window";
            ...
            case 1:
              targetEl = mode === "content" ? this.mainContentEl : this.el;
              _context5.prev = 2;
              _context5.next = 3;
              return window.html2canvas(targetEl, {
                ...
                onclone: function onclone(clonedDoc) {
                  var clonedTarget = clonedDoc.querySelector("#".concat(_this19.id));
                  if (!clonedTarget) return;
                  clonedTarget.classList.remove("".concat(_types.LIBRARY_NAME, "-is-resizing"), "".concat(_types.LIBRARY_NAME, "-is-dragging"));
                  var selectorsToRemove = [".".concat(_types.LIBRARY_NAME, "-resize-handle"), ".".concat(_types.LIBRARY_NAME, "-debug-overlay"), ".".concat(_types.LIBRARY_NAME, "-controls")];
                  selectorsToRemove.forEach(function (selector) {
                    clonedTarget.querySelectorAll(selector).forEach(function (el) {
                      return el.remove();
                    });
                  });
                }
            ...
            case 4:
              ...
              _e = new _errors.WinLetError("html2canvas failed to capture the window. Error: ".concat(_t2.message));
              _e.stack += "\n\n--- Caused by ---\n" + _t2.stack;
              console.error(_e);
...
var LIB_VERSION = exports.LIB_VERSION = "v1.0.3.2";
